<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.xuexiaotupian" label="学校图片" prop="xuexiaotupian">
          <file-upload
          tip="点击上传学校图片"
          action="file/upload"
          :limit="3"
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="人员数量" prop="renyuanshuliang">
          <el-input v-model="ruleForm.renyuanshuliang" 
              placeholder="人员数量" clearable  :readonly="ro.renyuanshuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="人员数量" prop="renyuanshuliang">
              <el-input v-model="ruleForm.renyuanshuliang" 
                placeholder="人员数量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="学校介绍" prop="xuexiaojieshao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.xuexiaojieshao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xuexiaojieshao" label="学校介绍" prop="xuexiaojieshao">
                    <span v-html="ruleForm.xuexiaojieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	xuexiaotupian : false,
	zhandimianji : false,
	renyuanshuliang : false,
	xuexiaojieshao : false,
	clicktime : false,
	clicknum : false,
      },
      ruleForm: {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhandimianji = true;
          ...
          if(o=='renyuanshuliang'){
            this.ruleForm.renyuanshuliang = obj[o];
	    this.ro.renyuanshuliang = true;
            continue;
          }
          if(o=='xuexiaojieshao'){
            this.ruleForm.xuexiaojieshao = obj[o];
	    this.ro.xuexiaojieshao = true;
            continue;
          }
          if(o=='clicktime'){
	...
	this.ruleForm.xuexiaojieshao = this.ruleForm.xuexiaojieshao.replace(reg,'../../../ssmiy239/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
