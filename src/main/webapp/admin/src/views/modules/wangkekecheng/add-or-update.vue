<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="课程时长" prop="kechengshizhang">
          <el-input v-model="ruleForm.kechengshizhang" 
              placeholder="课程时长" clearable  :readonly="ro.kechengshizhang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="课程时长" prop="kechengshizhang">
              <el-input v-model="ruleForm.kechengshizhang" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="老师工号" prop="laoshigonghao">
          <el-input v-model="ruleForm.laoshigonghao" 
              placeholder="老师工号" clearable  :readonly="ro.laoshigonghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="老师工号" prop="laoshigonghao">
              <el-input v-model="ruleForm.laoshigonghao" 
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.laoshigonghao!=''&&json.laoshigonghao){
	...
	this.ruleForm.kechengjieshao = this.ruleForm.kechengjieshao.replace(reg,'../../../ssmiy239/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `wangkekecheng/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.wangkekechengCrossAddOrUpdateFlag = false;
                  this.parent.search();
