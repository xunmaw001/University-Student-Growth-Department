  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(104, 223, 240, 1);fontSize:28px;">大学学生成长系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="联系手机" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.lianxishouji" autocomplete="off" placeholder="联系手机"  />
			</el-form-item>
			<!-- <div v-if="tableName=='laoshi'" class="input-group">
			   <div class="label">老师工号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.laoshigonghao" class="input" type="text" placeholder="老师工号">
			   </div>
			 </div> -->
			<el-form-item label="老师工号" class="input" v-if="tableName=='laoshi'">
			  <el-input v-model="ruleForm.laoshigonghao" autocomplete="off" placeholder="老师工号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='laoshi'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if(`xuesheng` == this.tableName && this.ruleForm.lianxishouji&&(!this.$validate.isMobile(this.ruleForm.lianxishouji))){
        this.$message.error(`联系手机应输入手机格式`);
        return
      }
      if((!this.ruleForm.laoshigonghao) && `laoshi` == this.tableName){
